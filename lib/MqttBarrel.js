...
mqttbarrel.newDivision = async function ( division ) {
	var self = this
	if ( !self.outs[division] )
		self.outs[division] = true
	return 'ok'
}
mqttbarrel.removeEntity = async function ( division, context, name ) {
	var self = this
...
mqttbarrel.newEntity = async function ( division, context, name ) {
	var self = this
...
mqttbarrel.appease = async function ( comm, err, responseComms ) {
	let self = this
...
mqttbarrel.intoxicate = async function ( comm ) {
	let self = this
